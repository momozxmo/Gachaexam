...
| 2 | "ทำตามที่วางimplementมาเลย" | directive | สร้าง `gacha-simulator.html` + verify logic |
| 3 | Main Rubric | QA | audit 110/110 |
| 4 | Bonus Rubric | QA | audit โบนัส ~20/20 |
| 5 | "ทำตามที่แนะนำเลย" | directive | inline edit + empty state + toast |
